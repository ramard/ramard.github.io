...
<body>
    ...
    <main id="main3">
        ...
        <article class="c2" id="dut">
            ...
            <p>Je suis actuellement en deuxième année de DUT Informatique à Lannion. C'est une formation qui me permet d'apporter des solutions informatiques pour les utilisateurs. 
                Nous apprenons plus concrètement à créer des logiciels, des applications Web, des applications mobiles, à gérer des bases de données, et bien d'autres compétences que vous pouvez retrouver dans le détail de la formation ci-dessous.</p>
        ...
        <article class="c1">
            ...
            <p>J'ai obtenu mon Baccalauréat avec la mention Bien, au Lycée la Fontaine des Eaux à Dinan avec comme option Sciences de l'Ingénieur et spécialité ISN (Informatique et Sciences du Numérique). Cette option m'a permis de débuter en informatique en voyant plusieurs notions importantes comme la programmation et le web. Elle m'a également confortée dans mon choix de poursuivre vers un DUT informatique.</p>
        ...
        <article class="c2">
                <h2>École de design - Nantes Atlantique | 2018/2019 - Alternant </h2>
